  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'elevation-3': '0 8px 16px rgba(0, 0, 0, 0.08), 0 4px 8px rgba(0, 0, 0, 0.06)',
        'elevation-4': '0 16px 32px rgba(0, 0, 0, 0.08), 0 8px 16px rgba(0, 0, 0, 0.06)',
        'glass': '0 8px 32px rgba(0, 0, 0, 0.1)',
        'glow-primary': '0 0 16px oklch(var(--primary) / 0.3)',
        'glow-success': '0 0 16px oklch(var(--success) / 0.3)',
        'glow-warning': '0 0 16px oklch(var(--warning) / 0.3)',
        'glow-error': '0 0 16px oklch(var(--error) / 0.3)',
      },
